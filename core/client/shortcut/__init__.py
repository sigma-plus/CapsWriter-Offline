...
if platform.system() == 'Linux':
    from core.client.shortcut.linux_shortcut_manager import LinuxShortcutManager as ShortcutManager
    from core.client.shortcut.linux_key_mapper import LinuxKeyMapper as KeyMapper
    from core.client.shortcut.linux_key_mapper import RESTORABLE_KEYS
else:
